...
public class TestBackendAnggota {
    public static void main(String[] args) {
        Anggota agt1 = new Anggota("Hunayn", "Sidaorjo", "081222200039");
        Anggota agt2 = new Anggota("Ardan", "Bojonegoro", "085212526856");
        Anggota agt3 = new Anggota("Dina", "Malang", "085755216488");
